...
public class Server {
  ...
  public interface Iface {
    ...
    public Map<String,Integer> ls() throws org.apache.thrift.TException;

    public boolean sync(Map<String,String> fs) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void sync(Map<String,String> fs, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public Map<String,Integer> recv_ls() throws org.apache.thrift.TException
    {
    ...
    public void send_sync(Map<String,String> fs) throws org.apache.thrift.TException
    {
    ...
    public boolean recv_sync() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void sync(Map<String,String> fs, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      sync_call method_call = new sync_call(fs, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class sync_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public sync_call(Map<String,String> fs, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.fs = fs;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class sync<I extends Iface> extends org.apache.thrift.ProcessFunction<I, sync_args> {
      ...
      public sync_result getResult(I iface, sync_args args) throws org.apache.thrift.TException {
        sync_result result = new sync_result();
        result.success = iface.sync(args.fs);
        result.setSuccessIsSet(true);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class sync<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, sync_args, Boolean> {
      public sync() {
        super("sync");
      }
      ...
      public void start(I iface, sync_args args, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler) throws TException {
        iface.sync(args.fs,resultHandler);
      }
    }
...
;
  ...
  public static class sync_args implements org.apache.thrift.TBase<sync_args, sync_args._Fields>, java.io.Serializable, Cloneable, Comparable<sync_args>   {
    ...
    private static final org.apache.thrift.protocol.TField FS_FIELD_DESC = new org.apache.thrift.protocol.TField("fs", org.apache.thrift.protocol.TType.MAP, (short)1);
    ...
    public Map<String,String> fs; // required
    ...
    public sync_args(sync_args other) {
      if (other.isSetFs()) {
        Map<String,String> __this__fs = new HashMap<String,String>(other.fs);
        this.fs = __this__fs;
      }
    }
    ...
    public int getFsSize() {
      return (this.fs == null) ? 0 : this.fs.size();
    }

    public void putToFs(String key, String val) {
      if (this.fs == null) {
    ...
    public sync_args setFs(Map<String,String> fs) {
      this.fs = fs;
      return this;
    }
    ...
    public int hashCode() {
      ...
      boolean present_fs = true && (isSetFs());
      list.add(present_fs);
      if (present_fs)
        list.add(fs);
    ...
    private static class sync_argsStandardScheme extends StandardScheme<sync_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.fs = new HashMap<String,String>(2*_map10.size);
                  String _key11;
                  String _val12;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, sync_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.fs != null) {
          ...
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, struct.fs.size()));
            for (Map.Entry<String, String> _iter14 : struct.fs.entrySet())
            {
    ...
    private static class sync_argsTupleScheme extends TupleScheme<sync_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, sync_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetFs()) {
          {
            oprot.writeI32(struct.fs.size());
            for (Map.Entry<String, String> _iter15 : struct.fs.entrySet())
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.fs = new HashMap<String,String>(2*_map16.size);
            String _key17;
            String _val18;
  ...
  public static class sync_result implements org.apache.thrift.TBase<sync_result, sync_result._Fields>, java.io.Serializable, Cloneable, Comparable<sync_result>   {
    ...
    public sync_result setSuccess(boolean success) {
      this.success = success;
      setSuccessIsSet(true);
      return this;
    }
